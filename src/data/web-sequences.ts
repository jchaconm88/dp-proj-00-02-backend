...
export const WEB_SEQUENCES_CATALOG: DefaultSequenceRecord[] = [
  ...
  { id: "web-default__variant-attribute-type", entity: "variant-attribute-type", prefix: "VT", digits: 4, format: "{prefix}-{number}", resetPeriod: "never", allowManualOverride: true, preventGaps: false, active: true, source: "default", readonly: true },
  { id: "web-default__filterable-attribute-type", entity: "filterable-attribute-type", prefix: "FT", digits: 4, format: "{prefix}-{number}", resetPeriod: "never", allowManualOverride: true, preventGaps: false, active: true, source: "default", readonly: true },
  ...
  { id: "web-default__production-order", entity: "production-order", prefix: "OP", digits: 6, format: DEFAULT_FORMAT, resetPeriod: "yearly", allowManualOverride: true, preventGaps: false, active: true, source: "default", readonly: true },
  { id: "web-default__recipe", entity: "recipe", prefix: "REC", digits: 6, format: DEFAULT_FORMAT, resetPeriod: "yearly", allowManualOverride: true, preventGaps: false, active: true, source: "default", readonly: true },
